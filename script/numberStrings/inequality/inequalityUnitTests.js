      ...
      // big 4 == big 4
      if (inequality('123456789012345678901234', '123456789012345678901234') == '0') {
      ...
      // big 4 == big 5
      if (inequality('123456789012345678901234', '123456789012345678901235') == '2') {
      ...
      // big 5 == big 4
      if (inequality('123456789012345678901235', '123456789012345678901234') == '1') {
      ...
      // big 5 == 0
      if (inequality('123456789012345678901235', '0') == '1') {
      ...
      // big -5 == big -5
      if (inequality('-123456789012345678901235', '-123456789012345678901235') == '0') {
